...
public class CommentController {
	...
	public String index(Model model) {
		...
		model.addAttribute("time", new SimpleDateFormat("dd-MM-YYYY HH:mm:ss").format(new Date()));
	...
	private Comment getComment(String userComment, CommentType commentType ) {
		
		Comment commentObj =new Comment();
		commentObj.setType(commentType);
		commentObj.setComment(userComment);
		return commentObj;
